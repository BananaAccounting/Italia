...
// @description = ODV Report finanziario Veneto
// @task = app.command
// @doctype = 100.100
...
function loadParam() {
	...
	param = {
		"reportName":"ODV report economico - Veneto",																//Save the report's name
		...
		"cellTitle1" : "ENTRATE",																					// Specify a cell title
		"cellTitle2" : "TOTALE ENTRATE",																				// Specify a cell title
		"cellTitle3" : "USCITE",																						// Specify a cell title
		"cellTitle4" : "TOTALE USCITE",																				// Specify a cell title
...
function loadForm() {
	...
	//
	form.push({"id":"LI", "gr":"A2", "bClass":"1", "description":"LIQUIDITÀ INIZIALE"});
	...
	form.push({"id":"LF", "description":"LIQUIDITÀ FINALE (Liquidità iniziale + totale entrate - totale uscite)", "sum": "LI;C;R"});
