...
function printRendicontoModA(banDoc, userParam) {
	...
	tableRow = table.addRow();
	tableRow.addCell("A) quote associative o apporti ancora dovuti", "alignLeft", 1);
	tableRow.addCell(formatValue(current), "alignRight", 1);
	tableRow.addCell(formatValue(previous),"alignRight", 1);
	
	tableRow = table.addRow();
	tableRow.addCell("B) immobilizzazioni", "alignLeft", 1);
	tableRow.addCell("", "alignRight", 1);
	tableRow.addCell("", "alignRight", 1);

	tableRow = table.addRow();
	tableRow.addCell("   I - immobilizzazioni immateriali", "alignLeft", 1);
	tableRow.addCell("", "alignRight", 1);
	tableRow.addCell("", "alignRight", 1);
	...
	tableRow = table.addRow();
	tableRow.addCell("      Totale", "alignLeft", 1);
	tableRow.addCell(formatValue(current), "alignRight", 1);
	tableRow.addCell(formatValue(previous),"alignRight", 1);

	tableRow = table.addRow();
	tableRow.addCell("   II - immobilizzazioni materiali", "alignLeft", 1);
	tableRow.addCell("", "alignRight", 1);
	tableRow.addCell("", "alignRight", 1);
