...
var BReportXml = class JsClass {
   ...
   /**
    * Adds schema and namespaces
    */
   addSchemaAndNamespaces(xmlDocument) {
   ...
   createFileName() {
      ...
      //take the initial file name from the xmlStructure
      for (let i = 0; i < this.xmlStructure.length; i++) {
         if (this.xmlStructure[i].fileName) {
            fileName = this.xmlStructure[i].fileName;
            break;
         }
      }
