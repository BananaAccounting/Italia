...
// @description = 4. Rendiconto gestionale
// @task = app.command
// @doctype = 100.*;110.*;130.*
// @docproperties = 
// @outputformat = none
...
function stampaReportNormale(banDoc, paramReport, stylesheet) {
   ...
   bReport.validateGroups_RendicontoGestionale(paramReport.userParam.column);
...
function stampaReportControllo(banDoc, paramReport) {
   ...
   bReportControllo.validateGroups_RendicontoGestionale(paramReport.userParam.column);
