...
//
// @id = ch.banana.it.extension.asd.reportraccoltafondi
// @api = 1.0
// @pubdate = 2024-01-05
// @publisher = Banana.ch SA
// @description = 5. Report raccolta fondi ASD
// @task = app.command
// @doctype = 100.*;110.*;130.*
// @docproperties = 
// @outputformat = none
...
function setCss(repStyleObj) {
	let textCSS = "";
	let file = Banana.IO.getLocalFile("file:script/ch.banana.it.extension.asd.reportraccoltafondi.css");
