...
// @id = ch.banana.it.extension.asd.reportraccoltafondi.test
// @api = 1.0
// @pubdate = 2024-01-05
// @publisher = Banana.ch SA
// @description = <TEST ch.banana.it.extension.asd.reportraccoltafondi.js>
// @task = app.command
// @doctype = *.*
// @docproperties = 
// @outputformat = none
// @inputdataform = none
// @includejs = ../ch.banana.it.extension.asd.reportraccoltafondi.js
// @timeout = -1
...
ReportRaccoltaFondiTest.prototype.testContabilitaSemplice = function() {
	...
	var banDoc = Banana.application.openDocument("file:script/../test/testcases/asd_gestionale_patrimoniale_test.ac2");
	Test.assert(banDoc);
