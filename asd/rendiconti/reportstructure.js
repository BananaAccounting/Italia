...
function createReportStructureStatoPatrimoniale() {
	...
	reportStructure.push({"id":"AA", "type":"group", "indent":"0", "bclass":"1", "description":"A) Quote associative o apporti da associati ancora dovuti"});
	...
	reportStructure.push({"id":"ABI1", "type":"group", "indent":"2", "bclass":"1", "description":"1) costi di impianto, di ampliamento e di sviluppo"});
	reportStructure.push({"id":"ABI2", "type":"group", "indent":"2", "bclass":"1", "description":"2) concessioni, licenze, marchi ed altri beni immateriali"});
	reportStructure.push({"id":"ABI3", "type":"group", "indent":"2", "bclass":"1", "description":"3) immobilizzazioni in corso e acconti"});
	reportStructure.push({"id":"ABI4", "type":"group", "indent":"2", "bclass":"1", "description":"4) altre"});
	reportStructure.push({"id":"ABI", "type":"total", "indent":"1", "description":"Totale", "sum":"ABI1;ABI2;ABI3;ABI4"});
	...
	reportStructure.push({"id":"ABII2", "type":"group", "indent":"2", "bclass":"1", "description":"2) impianti"});
	...
	reportStructure.push({"id":"ABII", "type":"total", "indent":"1", "description":"Totale", "sum":"ABII1;ABII2;ABII3;ABII4;ABII5"});
	...
	reportStructure.push({"id":"ABIII", "type":"total", "indent":"1", "description":"Totale", "sum":"ABIII1;ABIII2;ABIII3"});
	reportStructure.push({"id":"AB", "type":"total", "indent":"0", "description":"Totale immobilizzazioni", "sum":"ABI;ABII;ABIII"});
	...
	reportStructure.push({"id":"ACI1", "type":"group", "indent":"2", "bclass":"1", "description":"1) materie prime, sussidiarie e di consumo"});
	reportStructure.push({"id":"ACI2", "type":"group", "indent":"2", "bclass":"1", "description":"2) prodotti finiti e merci"});
	reportStructure.push({"id":"ACI3", "type":"group", "indent":"2", "bclass":"1", "description":"3) acconti"});
	reportStructure.push({"id":"ACI", "type":"total", "indent":"1", "description":"Totale", "sum":"ACI1;ACI2;ACI3"});
	...
	reportStructure.push({"id":"ACII3", "type":"total", "indent":"2", "description":"3) verso tesserati", "sum":"ACII3o;ACII3e", "excludeamount":true});
	...
	reportStructure.push({"id":"ACII4", "type":"total", "indent":"2", "description":"4) verso enti pubblici", "sum":"ACII4o;ACII4e", "excludeamount":true});
	...
	reportStructure.push({"id":"ACII5", "type":"total", "indent":"2", "description":"5) verso soggetti privati per contributi", "sum":"ACII5o;ACII5e", "excludeamount":true});
	...
	reportStructure.push({"id":"ACII6", "type":"total", "indent":"2", "description":"6) verso Federazioni Sportive Nazionali, Discipline Sportive Associative, Enti di Promozione Sportiva, Coni, Sport e Salute Spa, altri enti dell’ordinamento sportivo", "sum":"ACII6o;ACII6e", "excludeamount":true});
	...
	reportStructure.push({"id":"ACII7", "type":"total", "indent":"2", "description":"7) crediti tributari", "sum":"ACII7o;ACII7e", "excludeamount":true});
	...
	reportStructure.push({"id":"ACII8", "type":"total", "indent":"2", "description":"8) da 5 per mille", "sum":"ACII8o;ACII8e", "excludeamount":true});
	...
	reportStructure.push({"id":"ACII9", "type":"total", "indent":"2", "description":"9) imposte anticipate", "sum":"ACII9o;ACII9e", "excludeamount":true});
	...
	reportStructure.push({"id":"ACII10", "type":"total", "indent":"2", "description":"10) verso altri", "sum":"ACII10o;ACII10e", "excludeamount":true});
	reportStructure.push({"id":"ACII", "type":"total", "indent":"1", "description":"Totale", "sum":"ACII1;ACII2;ACII3;ACII4;ACII5;ACII6;ACII7;ACII8;ACII9;ACII10"});
	...
	reportStructure.push({"id":"ACIII1", "type":"group", "indent":"2", "bclass":"1", "description":"1) partecipazioni"});
	reportStructure.push({"id":"ACIII2", "type":"group", "indent":"2", "bclass":"1", "description":"2) altri titoli"});
	reportStructure.push({"id":"ACIII", "type":"total", "indent":"1", "description":"Totale", "sum":"ACIII1;ACIII2"});
	...
	reportStructure.push({"id":"ACIV4", "type":"group", "indent":"2", "bclass":"1", "description":"4) portafoglio e conto federale"});
	reportStructure.push({"id":"ACIV", "type":"total", "indent":"1", "description":"Totale", "sum":"ACIV1;ACIV2;ACIV3;ACIV4"});
	reportStructure.push({"id":"AC", "type":"total", "indent":"0", "description":"Totale attivo circolante", "sum":"ACI;ACII;ACIII;ACIV"});
	...
	reportStructure.push({"id":"PAII", "type":"total", "indent":"1", "description":"Totale", "sum":"PAII1;PAII2;PAII3"});
	reportStructure.push({"id":"dPAIII", "type":"title", "indent":"1", "description":"III - Patrimonio libero"});
	reportStructure.push({"id":"PAIII1", "type":"group", "indent":"2", "bclass":"2", "description":"1) Riserve di avanzi di gestione"});
	reportStructure.push({"id":"PAIII2", "type":"group", "indent":"2", "bclass":"2", "description":"2) Altre riserve"});
	reportStructure.push({"id":"PAIII", "type":"total", "indent":"1", "description":"Totale", "sum":"PAIII1;PAIII2"});
	reportStructure.push({"id":"PA", "type":"total", "indent":"0", "description":"Totale", "sum":"PAI;PAII;PAIII;PAIV"});
	reportStructure.push({"id":"dPB", "type":"title", "indent":"0", "description":"B) Fondi per rischi e oneri"});
	reportStructure.push({"id":"PB1", "type":"group", "indent":"1", "bclass":"2", "description":"1) per trattamento di quiescenza e obblighi simili"});
	reportStructure.push({"id":"PB2", "type":"group", "indent":"1", "bclass":"2", "description":"2) per imposte, anche differite"});
	reportStructure.push({"id":"PB3", "type":"group", "indent":"1", "bclass":"2", "description":"3) altri"});
	reportStructure.push({"id":"PB", "type":"total", "indent":"0", "description":"Totale", "sum":"PB1;PB2;PB3"});
	reportStructure.push({"id":"PC", "type":"group", "indent":"0", "bclass":"2", "description":"C) Trattamento di fine rapporto di lavoro subordinato"});
	...
	reportStructure.push({"id":"PD3", "type":"total", "indent":"1", "description":"3) debiti verso associati per finanziamenti", "sum":"PD3o;PD3e", "excludeamount":true});
	...
	reportStructure.push({"id":"PD4", "type":"total", "indent":"1", "description":"4) debiti verso Federazioni Sportive Nazionali, Discipline Sportive Associative, Enti di Promozione Sportiva", "sum":"PD4o;PD4e", "excludeamount":true});
	...
	reportStructure.push({"id":"PD9", "type":"total", "indent":"1", "description":"9) debiti verso istituti di previdenza e di sicurezza sociale", "sum":"PD9o;PD9e", "excludeamount":true});
	...
	reportStructure.push({"id":"PD10", "type":"total", "indent":"1", "description":"10) debiti verso dipendenti e collaboratori", "sum":"PD10o;PD10e", "excludeamount":true});
	...
	reportStructure.push({"id":"PD11", "type":"total", "indent":"1", "description":"11) altri debiti", "sum":"PD11o;PD11e", "excludeamount":true});
	reportStructure.push({"id":"PD", "type":"total", "indent":"0", "description":"Totale", "sum":"PD1;PD2;PD3;PD4;PD5;PD6;PD7;PD8;PD9;PD10;PD11"});
	...
	reportStructure.push({"id":"dCA", "type":"title", "indent":"", "description":"A) Costi e oneri da attività istituzionale"});
	...
	reportStructure.push({"id":"CA3", "type":"group", "indent":"", "bclass":"3", "description":"3) Affiliazioni e tesseramenti"});
	reportStructure.push({"id":"CA4", "type":"group", "indent":"", "bclass":"3", "description":"4) Godimento beni di terzi"});
	reportStructure.push({"id":"CA5", "type":"group", "indent":"", "bclass":"3", "description":"5) Personale"});
	reportStructure.push({"id":"CA6", "type":"group", "indent":"", "bclass":"3", "description":"6) svalutazioni delle immobilizzazioni materiali ed immateriali"});
	reportStructure.push({"id":"CA7", "type":"group", "indent":"", "bclass":"3", "description":"7) Ammortamenti"});
	reportStructure.push({"id":"CA8", "type":"group", "indent":"", "bclass":"3", "description":"8) Accantonamenti per rischi ed oneri"});
	reportStructure.push({"id":"CA9", "type":"group", "indent":"", "bclass":"3", "description":"9) Altri oneri istituzionali"});
	reportStructure.push({"id":"CA10", "type":"group", "indent":"", "bclass":"3", "description":"10) Rimanenze iniziali"});
	reportStructure.push({"id":"CA11", "type":"group", "indent":"", "bclass":"3", "description":"11) Accantonamento a riserva vincolata per decisione degli organi istituzionali"});
	reportStructure.push({"id":"CA12", "type":"group", "indent":"", "bclass":"3", "description":"12) Utilizzo riserva vincolata per decisione degli organi istituzionali"});
	reportStructure.push({"id":"CA", "type":"total", "indent":"", "description":"Totale", "sum":"CA1;CA2;CA3;CA4;CA5;CA6;CA7;CA8;CA9;CA10;CA11;CA12"});
	reportStructure.push({"id":"dCB", "type":"title", "indent":"", "description":"B) Costi e oneri da attività secondarie e strumentali"});
	...
	reportStructure.push({"id":"CB6", "type":"group", "indent":"", "bclass":"3", "description":"6) svalutazioni delle immobilizzazioni materiali ed immateriali"});
	reportStructure.push({"id":"CB7", "type":"group", "indent":"", "bclass":"3", "description":"7) Accantonamenti per rischi ed oneri"});
	reportStructure.push({"id":"CB8", "type":"group", "indent":"", "bclass":"3", "description":"8) Oneri diversi di gestione"});
	reportStructure.push({"id":"CB9", "type":"group", "indent":"", "bclass":"3", "description":"9) Rimanenze iniziali"});
	reportStructure.push({"id":"CB", "type":"total", "indent":"", "description":"Totale", "sum":"CB1;CB2;CB3;CB4;CB5;CB6;CB7;CB8;CB9"});
	reportStructure.push({"id":"dCC", "type":"title", "indent":"", "description":"C) Costi e oneri da attività di raccolta fondi e da attività commerciali connesse a scopi istituzionali"});
	reportStructure.push({"id":"CC1", "type":"group", "indent":"", "bclass":"3", "description":"1) Oneri per attività commerciali connesse a scopi istituzionali"});
	reportStructure.push({"id":"CC2", "type":"group", "indent":"", "bclass":"3", "description":"2) Oneri per raccolte pubbliche di fondi occasionali"});
	...
	reportStructure.push({"id":"CD5", "type":"group", "indent":"", "bclass":"3", "description":"5) Altri oneri"});
	reportStructure.push({"id":"CD", "type":"total", "indent":"", "description":"Totale", "sum":"CD1;CD2;CD3;CD4;CD5"});
	...
	reportStructure.push({"id":"CE8", "type":"group", "indent":"", "bclass":"3", "description":"8) svalutazioni delle immobilizzazioni materiali ed immateriali"});
	reportStructure.push({"id":"CE9", "type":"group", "indent":"", "bclass":"3", "description":"9) Accantonamento a riserva vincolata per decisione degli organi istituzionali"});
	reportStructure.push({"id":"CE10", "type":"group", "indent":"", "bclass":"3", "description":"10) Utilizzo riserva vincolata per decisione degli organi istituzionali"});
	reportStructure.push({"id":"CE", "type":"total", "indent":"", "description":"Totale", "sum":"CE1;CE2;CE3;CE4;CE5;CE6;CE7;CE8;CE9;CE10"});
	...
	reportStructure.push({"id":"dRA", "type":"title", "indent":"", "description":"A) Ricavi, rendite e proventi da attività istituzionale"});
	reportStructure.push({"id":"RA1", "type":"group", "indent":"", "bclass":"4", "description":"1) Proventi da quote associative"});
	reportStructure.push({"id":"RA2", "type":"group", "indent":"", "bclass":"4", "description":"2) Proventi da tesseramenti"});
	reportStructure.push({"id":"RA3", "type":"group", "indent":"", "bclass":"4", "description":"3) Proventi da associati e tesserati per partecipazione alle attività istituzionali"});
	reportStructure.push({"id":"RA4", "type":"group", "indent":"", "bclass":"4", "description":"4) Premio di formazione tecnica e indennità di preparazione"});
	reportStructure.push({"id":"RA5", "type":"group", "indent":"", "bclass":"4", "description":"5) Erogazioni liberali"});
	reportStructure.push({"id":"RA6", "type":"group", "indent":"", "bclass":"4", "description":"6) Proventi del 5 per mille"});
	reportStructure.push({"id":"RA7", "type":"group", "indent":"", "bclass":"4", "description":"7) Contributi da soggetti privati"});
	reportStructure.push({"id":"RA8", "type":"group", "indent":"", "bclass":"4", "description":"8) Contributi a fondo perduto o a rendicontazione da enti pubblici"});
	reportStructure.push({"id":"RA9", "type":"group", "indent":"", "bclass":"4", "description":"9) Ricavi per prestazioni e cessioni a terzi"});
	reportStructure.push({"id":"RA10", "type":"group", "indent":"", "bclass":"4", "description":"10) Proventi e ricavi da contratti con enti pubblici"});
	reportStructure.push({"id":"RA11", "type":"group", "indent":"", "bclass":"4", "description":"11) Proventi per attività in convenzione o in regime di accreditamento con enti pubblici"});
	reportStructure.push({"id":"RA12", "type":"group", "indent":"", "bclass":"4", "description":"12) Altri rendite e proventi"});
	reportStructure.push({"id":"RA13", "type":"group", "indent":"", "bclass":"4", "description":"13) Rimanenze finali"});
	reportStructure.push({"id":"RA", "type":"total", "indent":"", "description":"Totale", "sum":"RA1;RA2;RA3;RA4;RA5;RA6;RA7;RA8;RA9;RA10;RA11;RA12;RA13"});
	reportStructure.push({"id":"dRB", "type":"title", "indent":"", "description":"B) Ricavi, rendite e proventi da attività secondarie e strumentali"});
	reportStructure.push({"id":"RB1", "type":"group", "indent":"", "bclass":"4", "description":"1) Ricavi per prestazioni e cessioni ad associati e tesserati"});
	...
	reportStructure.push({"id":"RB5", "type":"group", "indent":"", "bclass":"4", "description":"5) Ricavi e proventi da contratti con enti pubblici"});
	...
	reportStructure.push({"id":"RBS1", "type":"total", "indent":"", "description":"Sub-totale", "sum":"RB1;RB2;RB3;RB4;RB5;RB6;RB7"}); //??
	reportStructure.push({"id":"RB8", "type":"group", "indent":"", "bclass":"4", "description":"8) Ricavi da sponsorizzazioni e prestazioni promo pubblicitarie"});
	reportStructure.push({"id":"RB9", "type":"group", "indent":"", "bclass":"4", "description":"9) Ricavi da cessione di diritti e indennità legate alla formazione degli atleti (oltre tariffe federali)"});
	reportStructure.push({"id":"RB10", "type":"group", "indent":"", "bclass":"4", "description":"10) Titoli di accesso"});
	reportStructure.push({"id":"RB11", "type":"group", "indent":"", "bclass":"4", "description":"11) Altri proventi e ricavi dalla gestione di impianti e strutture sportive"});
	reportStructure.push({"id":"RBS2", "type":"total", "indent":"", "description":"Sub-totale", "sum":"RB8;RB9;RB10;RB11"}); //??
	reportStructure.push({"id":"RB", "type":"total", "indent":"", "description":"Totale", "sum":"RB1;RB2;RB3;RB4;RB5;RB6;RB7;RB8;RB9;RB10;RB11"});
	reportStructure.push({"id":"dRC", "type":"title", "indent":"", "description":"C) Ricavi, rendite e proventi da attività di raccolta fondi e da attività commerciali connesse a scopi istituzionali"});
	reportStructure.push({"id":"RC1", "type":"group", "indent":"", "bclass":"4", "description":"1) Proventi da attività commerciali connesse a scopi istituzionali"});
	reportStructure.push({"id":"RC2", "type":"group", "indent":"", "bclass":"4", "description":"2) Proventi da raccolte pubbliche di fondi occasionali"});
	...
	reportStructure.push({"id":"RA-CA", "type":"total", "indent":"", "description":"Avanzo/disavanzo attività istituzionale (+/-)", "sum":"RA;-CA"});
	reportStructure.push({"id":"RB-CB", "type":"total", "indent":"", "description":"Avanzo/disavanzo attività secondarie e strumentali (+/-)", "sum":"RB;-CB"});
	reportStructure.push({"id":"RC-CC", "type":"total", "indent":"", "description":"Avanzo/disavanzo attività di raccolta fondi e attività commerciali connesse a scopi istituzionali", "sum":"RC;-CC"});
	...
	reportStructure.push({"id":"RE-CE", "type":"total", "indent":"", "description":"Avanzo/disavanzo attività di supporto generale (+/-)", "sum":"RE;-CE"});
...
function createPrintStructureRendicontoGestionale() {
	...
	printStructure.push({"id":"CA11"});
	printStructure.push({"id":"CA12"});
...
function createReportStructureRendicontoCassa() {
	...
	reportStructure.push({"id":"ACIV4", "type":"group", "indent":"", "bclass":"1", "description":"Portafoglio e conto federale"});
	reportStructure.push({"id":"ACIV", "type":"total", "indent":"", "description":"Cassa e banca", "sum":"ACIV1;ACIV3;ACIV4"});
	
	/* USCITE */
	reportStructure.push({"id":"dC", "description":"USCITE"});
	reportStructure.push({"id":"dCA", "type":"title", "indent":"", "description":"A) Uscite da attività istituzionali"});
	reportStructure.push({"id":"CA1", "type":"group", "indent":"", "bclass":"3", "description":"1) Materie prime, sussidiarie, di consumo e di merci"});
	reportStructure.push({"id":"CA2", "type":"group", "indent":"", "bclass":"3", "description":"2) Servizi"});
	reportStructure.push({"id":"CA3", "type":"group", "indent":"", "bclass":"3", "description":"3) Affiliazioni e tesseramenti"});
	reportStructure.push({"id":"CA4", "type":"group", "indent":"", "bclass":"3", "description":"4) Godimento beni di terzi"});
	reportStructure.push({"id":"CA5", "type":"group", "indent":"", "bclass":"3", "description":"5) Personale"});
	reportStructure.push({"id":"CA9", "type":"group", "indent":"", "bclass":"3", "description":"7) Altre uscite istituzionali"});
	reportStructure.push({"id":"CA", "type":"total", "indent":"", "description":"Totale", "sum":"CA1;CA2;CA3;CA4;CA5;CA9"});
	reportStructure.push({"id":"dCB", "type":"title", "indent":"", "description":"B) Uscite da attività secondarie e strumentali"});
	reportStructure.push({"id":"CB1", "type":"group", "indent":"", "bclass":"3", "description":"1) Materie prime, sussidiarie, di consumo e di merci"});
	reportStructure.push({"id":"CB2", "type":"group", "indent":"", "bclass":"3", "description":"2) Servizi"});
	reportStructure.push({"id":"CB3", "type":"group", "indent":"", "bclass":"3", "description":"3) Godimento beni di terzi"});
	reportStructure.push({"id":"CB4", "type":"group", "indent":"", "bclass":"3", "description":"4) Personale"});
	reportStructure.push({"id":"CB8", "type":"group", "indent":"", "bclass":"3", "description":"5) Uscite diverse di gestione"});
	reportStructure.push({"id":"CB", "type":"total", "indent":"", "description":"Totale", "sum":"CB1;CB2;CB3;CB4;CB8"});
	reportStructure.push({"id":"dCC", "type":"title", "indent":"", "description":"C) Uscite da attività di raccolta fondi e da attività commerciali connesse a scopi istituzionali"});
	reportStructure.push({"id":"CC1", "type":"group", "indent":"", "bclass":"3", "description":"1) Uscite per attività commerciali connesse a scopi istituzionali"});
	reportStructure.push({"id":"CC2", "type":"group", "indent":"", "bclass":"3", "description":"2) Uscite per raccolte pubbliche di fondi occasionali"});
	...
	reportStructure.push({"id":"CD3", "type":"group", "indent":"", "bclass":"3", "description":"3) Da patrimonio edilizio"});
	reportStructure.push({"id":"CD4", "type":"group", "indent":"", "bclass":"3", "description":"4) Da altri beni patrimoniali"});
	reportStructure.push({"id":"CD5", "type":"group", "indent":"", "bclass":"3", "description":"5) Altre uscite"});
	reportStructure.push({"id":"CD", "type":"total", "indent":"", "description":"Totale", "sum":"CD1;CD2;CD3;CD4;CD5"});
	...
	reportStructure.push({"id":"dRA", "type":"title", "indent":"", "description":"A) Entrate da attività istituzionali"});
	reportStructure.push({"id":"RA1", "type":"group", "indent":"", "bclass":"4", "description":"1) Entrate da quote associative"});
	reportStructure.push({"id":"RA2", "type":"group", "indent":"", "bclass":"4", "description":"2) Entrate da tesseramento sportivo"});
	reportStructure.push({"id":"RA3", "type":"group", "indent":"", "bclass":"4", "description":"3) Entrate da associati e tesserati per partecipazione alle attività istituzionali"});
	reportStructure.push({"id":"RA4", "type":"group", "indent":"", "bclass":"4", "description":"4) Premio di formazione tecnica e indennità di preparazione"});
	reportStructure.push({"id":"RA5", "type":"group", "indent":"", "bclass":"4", "description":"5) Erogazioni liberali"});
	reportStructure.push({"id":"RA6", "type":"group", "indent":"", "bclass":"4", "description":"6) Entrate del 5 per mille"});
	reportStructure.push({"id":"RA14", "type":"group", "indent":"", "bclass":"4", "description":"7) Contributi da Federazioni, enti dell’ordinamento sportivo"});
	reportStructure.push({"id":"RA7", "type":"group", "indent":"", "bclass":"4", "description":"8) Contributi da soggetti privati"});
	reportStructure.push({"id":"RA8", "type":"group", "indent":"", "bclass":"4", "description":"9) Contributi a fondo perduto o a rendicontazione da enti pubblici"});
	reportStructure.push({"id":"RA9", "type":"group", "indent":"", "bclass":"4", "description":"10) Entrate per prestazioni e cessioni a terzi"});
	reportStructure.push({"id":"RA10", "type":"group", "indent":"", "bclass":"4", "description":"11) Entrate da contratti con enti pubblici"});
	reportStructure.push({"id":"RA11", "type":"group", "indent":"", "bclass":"4", "description":"12) Entrate per attività in convenzione o in regime di accreditamento con enti pubblici"}); 
	reportStructure.push({"id":"RA12", "type":"group", "indent":"", "bclass":"4", "description":"13) Altre entrate istituzionali"}); 
	reportStructure.push({"id":"RA", "type":"total", "indent":"", "description":"Totale", "sum":"RA1;RA2;RA3;RA4;RA5;RA6;RA7;RA8;RA9;RA10;RA11;RA12;RA14"});
	reportStructure.push({"id":"dRB", "type":"title", "indent":"", "description":"B) Entrate da attività secondarie e strumentali"});
	reportStructure.push({"id":"RB1", "type":"group", "indent":"", "bclass":"4", "description":"1) Entrate per prestazioni di servizi"});
	reportStructure.push({"id":"RB12", "type":"group", "indent":"", "bclass":"4", "description":"2) Entrate per cessioni di beni"});
	reportStructure.push({"id":"RB2", "type":"group", "indent":"", "bclass":"4", "description":"3) Contributi da soggetti privati"});
	reportStructure.push({"id":"RB3", "type":"group", "indent":"", "bclass":"4", "description":"4) Entrate per prestazioni e cessioni a terzi"});
	reportStructure.push({"id":"RB4", "type":"group", "indent":"", "bclass":"4", "description":"5) Contributi da enti pubblici"});
	reportStructure.push({"id":"RB6", "type":"group", "indent":"", "bclass":"4", "description":"6) Altre entrate"});
	reportStructure.push({"id":"RBS1", "type":"total", "indent":"", "description":"Sub-totale", "sum":"RB1;RB12;RB2;RB3;RB4;RB6"});
	reportStructure.push({"id":"RB8", "type":"group", "indent":"", "bclass":"4", "description":"8) Proventi da sponsorizzazioni e prestazioni promo pubblicitarie"});
	reportStructure.push({"id":"RB9", "type":"group", "indent":"", "bclass":"4", "description":"9) Proventi da cessione di diritti e indennità legate alla formazione degli atleti (oltre tariffe federali)"});
	reportStructure.push({"id":"RB10", "type":"group", "indent":"", "bclass":"4", "description":"10) Titoli di accesso"});
	reportStructure.push({"id":"RB11", "type":"group", "indent":"", "bclass":"4", "description":"11) Altri proventi dalla gestione di impianti e strutture sportive"});
	reportStructure.push({"id":"RBS2", "type":"total", "indent":"", "description":"Sub-totale", "sum":"RB8;RB9;RB10;RB11"});
	reportStructure.push({"id":"RB", "type":"total", "indent":"", "description":"Totale", "sum":"RB1;RB12;RB2;RB3;RB4;RB6;RB8;RB9;RB10;RB11"});
	reportStructure.push({"id":"dRC", "type":"title", "indent":"", "description":"C) Entrate da attività di raccolta fondi e da attività commerciali connesse a scopi istituzionali"});
	reportStructure.push({"id":"RC1", "type":"group", "indent":"", "bclass":"4", "description":"1) Entrate da attività commerciali connesse a scopi istituzionali"});
	reportStructure.push({"id":"RC2", "type":"group", "indent":"", "bclass":"4", "description":"2) Entrate da raccolte pubbliche di fondi occasionali"});
	...
	reportStructure.push({"id":"RE3", "type":"group", "indent":"", "bclass":"4", "description":"3) Altre entrate di supporto generale"});
	reportStructure.push({"id":"RE", "type":"total", "indent":"", "description":"Totale", "sum":"RE1;RE3"});
	reportStructure.push({"id":"R", "type":"total", "indent":"", "description":"Totale entrate della gestione", "sum":"RA;RB;RC;RD;RE"});
	reportStructure.push({"id":"IM", "type":"group", "indent":"", "bclass":"4", "description":"Imposte"});

	/* AVANZO / DISAVANZO */
	  // => ricavi-costi (es RA;-CA)
	reportStructure.push({"id":"RA-CA", "type":"total", "indent":"", "description":"Avanzo/disavanzo attività istituzionali (+/-)", "sum":"RA;-CA"});
	reportStructure.push({"id":"RB-CB", "type":"total", "indent":"", "description":"Avanzo/disavanzo attività secondarie e strumentali (+/-)", "sum":"RB;-CB"});
	reportStructure.push({"id":"RC-CC", "type":"total", "indent":"", "description":"Avanzo/disavanzo attività di raccolta fondi e da attività commerciali connesse a scopi istituzionali (+/-)", "sum":"RC;-CC"});
	reportStructure.push({"id":"RD-CD", "type":"total", "indent":"", "description":"Avanzo/disavanzo attività finanziarie e patrimoniali (+/-)", "sum":"RD;-CD"});
	reportStructure.push({"id":"RE-CE", "type":"total", "indent":"", "description":"Avanzo/disavanzo attività di supporto generale (+/-)", "sum":"RE;-CE"});
	reportStructure.push({"id":"TADPI", "type":"total", "indent":"", "description":"Avanzo/disavanzo d’esercizio prima delle imposte (+/-)", "sum":"RA-CA;RB-CB;RC-CC;RD-CD;RE-CE"});
	reportStructure.push({"id":"TADES", "type":"total", "indent":"", "description":"Avanzo/disavanzo d’esercizio (+/-)", "sum":"TADPI;IM"});
