...
var ID_ERR_DATIFATTURE_MANCA_IDFILE = "ID_ERR_DATIFATTURE_MANCA_IDFILE";
var ID_ERR_DATIFATTURE_MANCA_PARTITAIVA = "ID_ERR_DATIFATTURE_MANCA_PARTITAIVA";
var ID_ERR_DATIFATTURE_NOMINATIVO_MANCANTE = "ID_ERR_DATIFATTURE_NOMINATIVO_MANCANTE";
...
function getErrorMessage(errorId) {
    switch (errorId) {
        ...
        case ID_ERR_DATIFATTURE_MANCA_PARTITAIVA:
            return "La partita IVA per clienti esteri è obbligatoria, in assenza scrivere 99999999999. %1";
        case ID_ERR_DATIFATTURE_NOMINATIVO_MANCANTE:
            return "Errore: nominativo mancante";
